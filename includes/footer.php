        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="block-5 mb-5">
                    ...
                    <ul class="list-unstyled">
                        <li class="address">NO.1, 2nd FLOOR ,MAIN BLOCK
                            KANDLAKOYA MEDCHAL,HYDERABAD,
                            RANGAREDDY,TELANGANA INDIA -500014 </li>
                        <li class="phone"><a href="tel://23923929210">+91 8374238667</a></li>
                        <li class="email">manohartangallapalli225@gmail.com</li>
                    </ul>
                </div>
        ...
        <div class="row pt-5 mt-5 text-center">
            <div class="col-md-12">
                <p>
                    ...
                    with by <a href="https://md-taha-ahmed.github.io/Portfolio-website/" target="_blank" class="text-primary">CSE:TEAM NO-B65</a>
                </p>
            </div>
